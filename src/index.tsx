...
import { Bars3Icon, XMarkIcon, DocumentDuplicateIcon as CopyIcon, ShareIcon } from '@heroicons/react/24/outline'
import 'flowbite'
  ...
  return (
    <div className="bg-white dark:bg-gray-900">
      ...
      <div className="relative isolate pt-14 ">
        ...
        <div className="mx-auto py-24 sm:py-32 lg:pb-40">
            ...
            <ol className="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400 transform">
              {
                ...
                />,
                  ...
                  <h3 className="leading-tight font-semibold text-left text-xl pb-2">{x.title}</h3>
                    <div className="">
                      {
                        x.content
                      }
